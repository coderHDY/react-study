...
export default class AliveScope extends Component {
    ...
    update = (id, params) =>
        new Promise((resolve) => {
            ...
            this.nodes.set(id, {
                id,
                createTime: now, // 逻辑错误？createTime应该是判断isNew后得出是否需要刷新
                updateTime: now,
                ...node,
                ...params,
            })
    ...
    render() {
        ...
        console.log(this.store); // Map(1) {'Home' => {…}}
        console.log(this.nodes); // Map(1) {'Home' => {…}}
        console.log(this.keepers); // Map(1) {'Home' => Keeper}
