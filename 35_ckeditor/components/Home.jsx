    ...
    <div className="App">
      ...
      <CKEditor
        ...
        config={{
          ...
          // placeholder: `请填写内容`,
          extraPlugins:
            "emoji,image2,uploadimage,quicktable,colorbutton,confighelper,blockquote",
        ...
        onFileUploadResponse={(evt) => {
          ...
          // disabled
          const ipt =
            evt.editor._.storedDialogs.image2.parts.contents.$.querySelector(
              ".cke_dialog_image_url input.cke_dialog_ui_input_text"
            );
